from new_train.config import cfg,log_cfg_to_file
...
def parse_config():
    ...
    if using_IED:
        ...
        parser.add_argument('--TAG', type=str, default="LZnet", help='specify the config for training')
        ...
        parser.add_argument('--extra_tag', type=str, default='0.1.4', help='extra tag for this experiment')
        ...
        parser.add_argument('--detector_name', type=str, default="LZnet", help='select the detector model')
