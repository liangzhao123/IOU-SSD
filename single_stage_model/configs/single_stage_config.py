...
cfg.data_config = {
    ...
    "TRAIN":{"max_number_of_voxel": 20000,
                         "info_path": [os.path.join(cfg.CODE_DIR, "single_stage_model",
                                                    "data/kitti/database_information/kitti_infos_train.pkl"),
                                       # os.path.join(cfg.CODE_DIR, "single_stage_model",
                                       #              "data/kitti/database_information/kitti_infos_trainval.pkl")
                                       ],
                         "SHUFFLE_POINTS": True},
    ...
    "offical_test_info_path": [
        os.path.join(cfg.CODE_DIR, "single_stage_model", "data/kitti/database_information/kitti_infos_test.pkl")],
    ...
    "augmentation": {
        "db_sampler": {
            ...
            "db_info_path": [os.path.join(cfg.CODE_DIR, "single_stage_model",
                                          "data/kitti/database_information/kitti_dbinfos_train.pkl"),
                             os.path.join(cfg.CODE_DIR, "single_stage_model",
                                          "data/kitti/database_information/kitti_dbinfos_trainval.pkl"),
                             os.path.join(cfg.CODE_DIR, "single_stage_model",
                                          "data/kitti/database_information/kitti_dbinfos_train_80%.pkl")],
...
cfg.kitti_info_path = os.path.join(cfg.CODE_DIR, "single_stage_model/data/kitti/database_information")
cfg.gt_database = os.path.join(cfg.CODE_DIR, "single_stage_model/data/kitti/database")
