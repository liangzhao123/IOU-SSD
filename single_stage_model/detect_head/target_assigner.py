...
class AxisAlignedTargetAssigner(object):
    def __init__(self, anchor_cfg, class_names, box_coder):
        ...
        self.match_height = anchor_cfg.match_height
        self.class_names = class_names
        self.anchor_class_names = [config['class_name'] for config in anchor_cfg.anchor_generator]
        self.pos_fraction = anchor_cfg.pos_fraction if \
            anchor_cfg.pos_fraction >= 0 else None
        self.sample_size = anchor_cfg.sample_size
        self.norm_by_num_examples = anchor_cfg.norm_by_num_samples
