...
import single_stage_model.dataset
# import pvdet.dataset.utils.common_utils as common_utils
from single_stage_model.dataset import common_utils as common_utils
...
def remove_points_in_boxes3d_v1(points, boxes3d):
    """
    Args:
...
def boxes3d_lidar_to_aligned_bev_boxes(boxes3d):
    ...
    """
    rot_angle = common_utils.limit_period(boxes3d[:, 6], offset=0.5, period=np.pi).abs()#角度先转化为(0~pi/2)
