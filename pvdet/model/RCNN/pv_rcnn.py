...
import pvdet.tools.utils.loss_utils as loss_utils
...
class PV_Rcnn(PvRcnnBase):
    ...
    def forward(self,batch_dict):
        batch_dict = self.proposal_layer(batch_dict,self.model_cfg.NMS_CONFIG["TRAIN"] if self.training else self.model_cfg.NMS_CONFIG["TEST"])
