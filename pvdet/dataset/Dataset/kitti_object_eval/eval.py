...
import numba
import io as sysio
from pvdet.dataset.Dataset.kitti_object_eval.rotation_iou import rotate_iou_gpu_eval
import time
...
def do_eval(gt_annos,
    ...
    ret = eval_class(gt_annos,dt_annos,current_classes,
                     difficultys,0,min_overlaps,compute_aos)
    ...
    for i in range(gt_size):
        ...
        for j in range(det_size):
            ...
            if ignored_threshold[j]:
                continue
            overlap = overlaps[i,j] #我觉得源码这里写错了
